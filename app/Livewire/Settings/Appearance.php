...
class Appearance extends Component
{
    ...
    {
        $this->validate(['site_banner' => 'image|max:2048']);
    }
    ...
    public function save()
    {
        $this->validate([
            ...
            'site_banner' => 'nullable|image|max:2048',
            'site_theme' => 'required|string',
        ]);
        ...
        // 4. Guardar Tema
        Setting::updateOrCreate(['key' => 'site_theme'], ['value' => $this->site_theme]);
